...
local sea_deep  = hsl(208, 20, 10)  -- the integers used here.
...
local theme = lush(function()
  return {
    ...
    -- (`setlocal number`)
    LineNr       { bg = Normal.bg, fg = Normal.bg.li(10) }, -- Line number for ":number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
    ...
    DiffAdd      { fg = "hsl(120,60,70)" }, -- diff mode: Added line |diff.txt|
    DiffChange   { fg = "hsl(200,60,60)"}, -- diff mode: Changed line |diff.txt|
    DiffDelete   { fg = "hsl(0, 60, 60)"}, -- diff mode: Deleted line |diff.txt|
    -- DiffText     { }, -- diff mode: Changed text within a changed line |diff.txt|
    -- EndOfBuffer  { }, -- filler lines (~) after the end of the buffer.  By default, this is highlighted like |hl-NonText|.
    -- TermCursor   { }, -- cursor in a focused terminal
    -- TermCursorNC { }, -- cursor in an unfocused terminal
    -- ErrorMsg     { }, -- error messages on the command line
    VertSplit    { bg = "NONE",guibg = "NONE", fg = Normal.bg.li(2)}, -- the column separating vertically split windows
    ...
    Pmenu        { bg = Normal.bg.li(25) }, -- Popup menu: normal item.
    ...
    Conditional    { fg = Normal.fg.ro(60).li(25).sa(25) }, --  if, then, else, endif, switch, etc.
    Repeat         { fg = Normal.fg.ro(60).sa(50).da(5) }, --   for, do, while, etc.
    -- Label          { }, --    case, default, etc.
    Operator       { fg = "#ffffff"}, -- "sizeof", "+", "*", etc.
    Keyword        { fg = Normal.fg.ro(120).sa(25) }, --  any other keyword
    ...
    LspDiagnosticsError               { fg = "hsl(0,60,60)" }, -- used for "Error" diagnostic virtual text
    LspDiagnosticsErrorSign           { fg = LspDiagnosticsError.fg}, -- used for "Error" diagnostic signs in sign column
    ...
    NvimTreeNormal {bg = Normal.bg.li(3)},
    NvimTreeVertSplit {fg = NvimTreeNormal.bg, bg = NvimTreeNormal.bg},
    IndentBlanklineChar {fg = Normal.bg.de(5).li(5)},
  }
end)

...
-- open projects
map('n', '<leader>p', ":lua require'telescope'.extensions.project.project{}<CR>")
...
local mappings = {
    ...
    w = {
        name = "+Window",
        h = "Change vertical split window to horizontal",
        v = "Change horizontal split window to vertical"
    },
